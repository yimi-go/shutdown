...
func (m *MockCallback) OnShutdown(ctx context.Context, event Event) error {
	m.ctrl.T.Helper()
...
func (m *MockTrigger) Wait(ctx context.Context, c Controller) error {
	m.ctrl.T.Helper()
...
func (m *MockController) AddShutdownCallback(callback Callback) {
	m.ctrl.T.Helper()
...
func (m *MockController) AddTrigger(trigger Trigger) {
	m.ctrl.T.Helper()
...
func (m *MockController) HandleShutdown(ctx context.Context, event Event) {
	m.ctrl.T.Helper()
